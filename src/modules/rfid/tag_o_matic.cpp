...
void TagOMatic::select_state() {
    ...
    if (_read_uid) {
        ...
        options.emplace_back("UID Customizado", [this]() { set_state(CUSTOM_UID_MODE); });
    ...
    options.emplace_back("Escanear tags", [this]() { set_state(SCAN_MODE); });
...
void TagOMatic::set_state(RFID_State state) {
    ...
    switch (state) {
        ...
        case CHECK_MODE:
            ...
            padprintln("UID Origem: " + _sourceUID);
            padprintln("");
            break;
        case CLONE_MODE:
        ...
        case WRITE_MODE:
            ...
            padprintln(String(_rfid->dataPages) + " paginas de dados para gravar");
            padprintln("");
            break;
...
void TagOMatic::display_banner() {
    ...
    switch (current_state) {
        ...
        case SCAN_MODE: printSubtitle("MODO SCAN"); break;
        case CHECK_MODE: printSubtitle("MODO VERIFICAR"); break;
        case LOAD_MODE: printSubtitle("MODO CARREGAR"); break;
        case CLONE_MODE: printSubtitle("MODO CLONAR"); break;
        case CUSTOM_UID_MODE: printSubtitle("MODO UID CUST."); break;
...
void TagOMatic::dump_card_details() {
    ...
    if (_rfid->printableUID.picc_type != "FeliCa") {
        ...
        padprintln("Codigo Sys: " + _rfid->printableUID.atqa);
    }
