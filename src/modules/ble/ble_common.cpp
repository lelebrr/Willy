...
void ble_info(String name, String address, String signal) {
    ...
    tft.drawString("Endere.: " + address, 10, 66);
    tft.drawString("Sinal: " + String(signal) + " dBm", 10, 84);
    tft.drawCentreString("   Pressione " + String(BTN_ALIAS) + " p/ agir", tftWidth / 2, tftHeight - 20, 1);
...
bool initBLEServer() {
    ...
    String blename = "Wily-" + String((uint8_t)(chipid >> 32), HEX);
