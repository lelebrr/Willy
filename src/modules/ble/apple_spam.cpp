...
void startAppleSpamAll() {
    ...
    drawMainBorderWithTitle("Spam Apple Geral");
    padprintln("");
    padprintln("Ciclando 15 payloads Apple");
...
void appleSubMenu() {
    ...
    appleOptions.push_back({"Spam Apple Geral", []() {
        startAppleSpamAll();
    }});
    ...
    appleOptions.push_back({"Voltar", []() {
        returnToMenu = true;
    }});

    loopOptions(appleOptions, MENU_TYPE_SUBMENU, "Spam Apple");
}
