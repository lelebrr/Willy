...
// Existing functions
bool playAudioFile(FS *fs, const String& filepath, PlaybackMode mode = PLAYBACK_BLOCKING);
bool playAudioRTTTLString(const String& song, PlaybackMode mode = PLAYBACK_BLOCKING);
