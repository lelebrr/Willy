...
/**
 * @brief Registra o comando composto "hw" no CLI serial.
 * Subcomandos: info, pininfo, peripheral, configpin, testpin, i2cscan,
 * hwreport, resetpins, periphstatus, loadhwconfig, savehwconfig.
 */
