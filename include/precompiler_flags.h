...
#include <pins_arduino.h>
  ...
  #define INPUT_HANDLER_TASK_STACK_SIZE 8192
#endif
...
// Boards without PSRAM need smaller stack sizes to be able to run properly
#ifndef SERIAL_CMDS_TASK_STACK_SIZE
  #define SERIAL_CMDS_TASK_STACK_SIZE 16384
#endif
#ifndef INTERPRETER_TASK_STACK_SIZE
  #define INTERPRETER_TASK_STACK_SIZE 8192
#endif
  ...
  #define GROVE_SCL -1
#endif
#ifndef SYS_I2C_SDA         // Pin used by system peripherals (touch, PMIC, RTC...)
  #define SYS_I2C_SDA -1
#endif
#ifndef SYS_I2C_SCL         // Pin used by system peripherals (touch, PMIC, RTC...)
