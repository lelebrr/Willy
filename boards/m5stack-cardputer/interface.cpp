...
void _post_setup_gpio() {
    ...
    wilyConfigPins.sys_i2c.sda = (gpio_num_t)8;
    wilyConfigPins.sys_i2c.scl = (gpio_num_t)9;

    wilyConfigPins.gps_bus.rx = (gpio_num_t)15;
    wilyConfigPins.gps_bus.tx = (gpio_num_t)13;
    wilyConfigPins.gpsBaudrate = 115200;

    wilyConfigPins.CC1101_bus.sck = (gpio_num_t)40;
    wilyConfigPins.CC1101_bus.miso = (gpio_num_t)39;
    wilyConfigPins.CC1101_bus.mosi = (gpio_num_t)14;
    wilyConfigPins.CC1101_bus.cs = (gpio_num_t)13;
    wilyConfigPins.CC1101_bus.io0 = (gpio_num_t)5;

    wilyConfigPins.NRF24_bus.sck = (gpio_num_t)40;
    wilyConfigPins.NRF24_bus.miso = (gpio_num_t)39;
    wilyConfigPins.NRF24_bus.mosi = (gpio_num_t)14;
    wilyConfigPins.NRF24_bus.cs = (gpio_num_t)6;
    wilyConfigPins.NRF24_bus.io0 = (gpio_num_t)4;

    pinMode(wilyConfigPins.NRF24_bus.cs, OUTPUT);
    pinMode(wilyConfigPins.CC1101_bus.cs, OUTPUT);
    pinMode(wilyConfigPins.LoRa_bus.cs, OUTPUT);
    digitalWrite(wilyConfigPins.NRF24_bus.cs, HIGH);
    digitalWrite(wilyConfigPins.CC1101_bus.cs, HIGH);
    digitalWrite(wilyConfigPins.LoRa_bus.cs, HIGH);
