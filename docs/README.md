...
|--------------|-----------|
| **MAC Spoofing** | Altera MAC address |
| **WiFi Config** | Redes salvas |
| **AP Config** | Modo Access Point |

### Hardware

| Configuração | Descrição |
|--------------|-----------|
| **IR TX Pin** | Pino do LED IR |
| **IR RX Pin** | Pino do receptor |
| **RF Config** | Configurações CC1101 |
| **NFC Config** | Configurações PN532 |
