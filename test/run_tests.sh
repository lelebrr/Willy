...
# Compile type_convertion tests
g++ -I./test test/test_type_convertion.cpp src/core/type_convertion.cpp -o test/test_runner_type_convertion

# Run type_convertion tests
./test/test_runner_type_convertion || FAILED=1

rm -f test/test_runner_type_convertion
